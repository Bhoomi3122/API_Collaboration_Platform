...
function Dashboard() {
  ...
  const recentShared = [...sharedWorkspaces]
    .sort((a, b) => {
      const counts = getVisitCounts();
      return (counts[b.id] || 0) - (counts[a.id] || 0);
    })
      ...
      <main className="dashboard-main">
        ...
        <div className="dashboard-content">
          ...
          <div className="stats-row">
            ...
            <div className="stat-card">
              <span className="stat-value">{loading ? "—" : sharedWorkspaces.length}</span>
          ...
          <div className="workspaces-section">
            <div className="section-header">
              <div className="section-title-group">
                ...
                <span className="section-count">{sharedWorkspaces.length}</span>
              </div>
            ...
            <div className="workspaces-grid">
              {loading ? (
                <p style={{ color: "var(--text-secondary)", gridColumn: "1 / -1" }}>Loading shared workspaces...</p>
